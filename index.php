...
<head>
	<title>UNISBA ACTION FIGURE</title>
	<meta charset="utf-8">
					...
					<div class="row">
						<div class="col">
							<div class="header_content d-flex flex-row align-items-center justify-content-start">
								<div class="logo"><a href="index.php">UNISBA ACTION FIGURE</a></div>
								<nav class="main_nav">
									<ul>
			...
			<div class="home_slider_container">
				...
				<div class="owl-carousel owl-theme home_slider">
					...
					<div class="owl-item home_slider_item">
						<div class="home_slider_background" style="background-image:url(images/buku.jpg)"></div>
									...
									<div class="col">
										<div class="home_slider_content" data-animation-in="fadeIn" data-animation-out="animate-out fadeOut">
											<div class="home_slider_title">
												<font size="5px">Toko Action Figure Terlengkap</font> <br>Di Indonesia.
											</div>
											<div class="home_slider_subtitle">Selamat Datang di UNISBA ACTION FIGURE</div>
											<br><center><p>Repost by <a href='https://Putra & Akbar/' title='Putra & Akbar' target='_blank'>Putra & Akbar</a></p></center>
				...
				<div class="row icon_box_row">
					...
					<div class="col-lg-4 icon_box_col">
						<div class="icon_box">
							...
							<div class="icon_box_text">
								<p>Khawatir barang tidak cocok? Jangan khawatir, karena apapun alasannya retur di UNISBA ACTION FIGURE gratis & mudah!</p>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col">
						<div class="footer_content d-flex flex-lg-row flex-column align-items-center justify-content-lg-start justify-content-center">
							<div class="footer_logo"><a href="index.php">UNISBA ACTION FIGURE</a></div>
							<div class="copyright ml-auto mr-auto">
								<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
								Copyright &copy;<script>
									document.write(new Date().getFullYear());
								</script> All rights reserved | UNISBA ACTION FIGURE <br>
